...
3D models placed in this folder and listed in `manifest.json` are credited here. None are
...
|------|-------|--------|--------|---------|
| _(example)_ house.glb | Medieval House | KayKit (Kay Lousberg) | kaylousberg.itch.io | CC0 |
