...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  { id: 'tools500', title: 'Produce 500 Iron Tools', tier: 'silver', done: (s) => produced(s, 'tools') >= 500 },
  ...
  { id: 'tools1k', title: 'Produce 1,000 Iron Tools', tier: 'gold', done: (s) => produced(s, 'tools') >= 1000 },
